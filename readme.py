...
python_tree = tree.add("📦 [b]Open Source Packages", guide_style="bright_black")
...
contrib_tree = tree.add("👍 [b]Contributions", guide_style="bright_black")
...
online_tree = tree.add("⭐ [b]Online Projects", guide_style="bright_black")
...
talk_tree = tree.add("🎙️ [b]Popular Talks", guide_style="bright_black")
...
employer_tree = tree.add("👨‍💻 [b]Employer", guide_style="bright_black")
