...
python_tree.add("[bold link=https://koaning.github.io/whatlies/]icepickle[/]      - [bright_black]cool and safe storage for linear models")
...
contrib_tree.add("[bold link=https://github.com/koaning/tokenwiser]tokenwiser[/]    - [bright_black]sklearn token tricks via .fit_partial()")
