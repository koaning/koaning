...
python_tree.add("[bold link=https://koaning.github.io/scikit-partial/]scikit-partial[/] - [bright_black]partial_fit() pipelines for sklearn")
...
python_tree.add("[bold link=https://koaning.github.io/clumper/]clumper[/]        - [bright_black]functional API for lists of dicts")
