...
experiments_tree.add("[bold link=https://github.com/koaning/akin]akin[/]           - [bright_black]sort based on zero-shot similarities")
experiments_tree.add("[bold link=https://github.com/koaning/tjek]tjek[/]           - [bright_black]tjek changes with the main branch")
...
experiments_tree.add("[bold link=https://github.com/koaning/scikit-teach/]scikit-teach[/]   - [bright_black]some active learning benchmarks")
experiments_tree.add("[bold link=https://github.com/koaning/tokenwiser]tokenwiser[/]     - [bright_black]sklearn token tricks")
experiments_tree.add("[bold link=https://github.com/koaning/benchmarks]benchmarks[/]     - [bright_black]some random, but intersting, benchmarks")
experiments_tree.add("[bold link=https://github.com/koaning/whatlies]whatlies[/]       - [bright_black]word embeddings for sklearn pipelines")
experiments_tree.add("[bold link=https://github.com/koaning/simsity]simsity[/]        - [bright_black]a super simple similarities service")
