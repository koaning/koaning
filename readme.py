...
python_tree.add("[bold link=https://github.com/koaning/narlogs/]narlogs[/]           - [bright_black]logs all dataframe pipelines")
...
probabl_tree.add("[bold link=https://github.com/koaning/scikit-mdn]scikit-mdn[/]        - [bright_black]mixture density networks")
