...
python_tree.add("[bold link=https://koaning.github.io/human-learn/]whatlies[/]    - [bright_black]word embeddings for sklearn pipelines")
python_tree.add("[bold link=https://koaning.github.io/human-learn/]clumper[/]     - [bright_black]function API for lists of dicts")
python_tree.add("[bold link=https://koaning.github.io/human-learn/]evol[/]        - [bright_black]grammar for genetic heuristics")
python_tree.add("[bold link=https://koaning.github.io/human-learn/]memo[/]        - [bright_black]saves a whole log of time")
python_tree.add("[bold link=https://koaning.github.io/human-learn/]drawdata[/]    - [bright_black]draw datasets in jupyter")
python_tree.add("[bold link=https://koaning.github.io/human-learn/]tokenwiser[/]  - [bright_black]sklearn token tricks via .fit_partial()")
python_tree.add("[bold link=https://koaning.github.io/human-learn/]mktestdocs[/]  - [bright_black]turn markdown files into pytest tests")
...
online_tree.add("[bold link=https://calmcode.io]dearme.email[/] - [bright_black]reflection service")
